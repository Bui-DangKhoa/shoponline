    ...
    componentDidUpdate(prevProps) {
        if (this.props.item !== prevProps.item) {
                this.setState({
                    ...
                    imgProduct: (this.props.item.image && (this.props.item.image.startsWith('http') || this.props.item.image.startsWith('data:'))) ? this.props.item.image : ('data:image/jpg;base64,' + this.props.item.image)
                });
        }
    }
    // event-handlers
