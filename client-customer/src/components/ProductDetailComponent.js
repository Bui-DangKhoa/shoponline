...
class ProductDetail extends Component {
    static contextType = MyContext; // access global state via this.context
    constructor(props) {
        super(props);
        this.state = {
            product: null
    ...
    render() {
        ...
        if (prod != null) {
            const imgSrc = prod && prod.image
                ? (prod.image.startsWith('http') || prod.image.startsWith('data:') ? prod.image : 'data:image/jpg;base64,' + prod.image)
                : '';
            return (
                <div className="align-center">
                    <h2 className="text-center">PRODUCT DETAILS</h2>
                    <figure className="caption-right">
                        <img src={imgSrc} width="400px" height="400px" alt="" />
                        <figcaption>
